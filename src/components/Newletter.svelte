<div class="newsletter">
  <h4>NEWSLETTER</h4>
  <p>Recibe las ultima novedades sobre frontend y nuevas tecnologias</p>
  <form
    action="https://tinyletter.com/masterEscorp"
    method="post"
    target="popupwindow"
    onsubmit="window.open('https://tinyletter.com/masterEscorp', 'popupwindow', 'scrollbars=yes,width=800,height=600');return true"
  >
